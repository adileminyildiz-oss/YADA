...
## 🟢 Dernière mise à jour — Notifications refondues (toast pilule vitrée + badge coloré) + bouton de téléchargement icône ronde (⬇ → ✓ 4 s) + Accueil : « Liste des dossiers » = TOUS les dossiers, tuile « Créer un dossier » retirée — v566
